...
if __name__ == "__main__":
    ...
    if repeated_version:
        tour = repeated_constructive_algorithm(instances=instance,constructive_algorithm=nearest_neighbor_algorithm,verbose=verbose_mode)
        if apply_local_search:
            tour = local_search.local_search(tour=tour,verbose=verbose_mode)
    else:
        if apply_local_search:
            tour = local_search.local_search(instances=instance,constructive_algorithm=nearest_neighbor_algorithm,
